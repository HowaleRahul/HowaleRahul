...
- Designed and developed a digital college food ordering system.
- Implemented role-based access (Admin, Teacher, Student).
- Reduced manual order processing time by 40–50%.
...
### 2. CyberGuardian (Java Web Application)
**Tech Stack:** Java, JSP, Servlet, JDBC, MySQL  

- Developed interactive cybersecurity learning platform.
